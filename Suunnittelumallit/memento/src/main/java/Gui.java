...
public class Gui extends Application {
    ...
    public void start(Stage stage) {
        ...
        // Create a button to open the history window
        Button historyButton = new Button("Show History");
        historyButton.setOnAction(event -> controller.showHistoryWindow());

        // create a VBox that contains the HBox, the CheckBox, the label, and the history button
